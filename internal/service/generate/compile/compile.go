...
func (c *Compiler) createFile(pkgPath, pkgName string) *ast.File {
	file := &ast.File{
		Doc: &ast.CommentGroup{
			List: []*ast.Comment{
				c.factory.Comment("// DO NOT EDIT"),
				c.factory.Comment("// Code generated by Gelato"),
			},
		},
	}

	c.factory.IncOffset(1) // newline before package
	file.Package = c.factory.PackagePos()
	file.Name = c.factory.Ident(pkgName + "test")

	c.factory.IncOffset(1) // newline before import
	file.Decls = append(file.Decls, c.factory.ImportDecl(pkgPath))
