...
func NewGRPCServer(greetingHandler handler.GreetingHandler, opts GRPCServerOptions) (*GRPCServer, error) {
	if opts.Port == 0 {
	...
	greetingpb.RegisterGreetingServiceServer(server, greetingHandler)
